                            ...
                            <table class="table table-sm text-nowrap table-striped table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="check, key in asset_checks" :key="key">
                                        ...
                                        <td>{{check?.asset_service?.service?.service_name}}</td>
    ...
    export default {
        ...
        methods: {
            ...
            editCheck(check) {
                ...
                const selectedService = this.formattedTemplateServices.find((service) => service.asset_service_id === check.asset_service_id);
