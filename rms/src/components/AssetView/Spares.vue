                ...
                <div class="row mb-3 g-2" v-can="['assetSpares.create','assetSpares.update']">
                    <div class="col-md-4">
                        ...
                        <MultiSelect
                            ...
                            id="asset_service_id"
                            @input="templateservice1 => spare.asset_service_id = templateservice1"
                                ...
                                <thead>
                                    <tr class="">
                                        ...
                                        <th>
                                            Service
                                            <span>
                                                <i v-if="meta.keyword=='asset_service_id' && meta.order_by=='asc'" class="ri-arrow-up-line"></i>
                                                <i v-else-if="meta.keyword=='asset_service_id' && meta.order_by=='desc'" class="ri-arrow-down-line"></i>
                                                <i v-else class="fas fa-sort"></i>
                                            </span>
                                        </th>
                                        <th>
    ...
    export default {
        ...
        methods: {
            ...
            getAssetSpares() {
                ...
                vm.$store
                    ...
                    .then((response) => {
                        ...
                        vm.asset_spare_services = response.data.asset_spare_services;
            ...
            editSpare(spare) {
                ...
                const selectedSpare = this.formattedTemplateSpareServices.find((service) => service.asset_service_id === spare.asset_service_id);

                if (selectedSpare) {
                    this.spare.spare_asset_zones_obj = [selectedSpare];
                    this.spare.asset_service_id = selectedSpare.asset_service_id;
                }
            },
            ...
            addSpare() {
                ...
                vm.spare.spare_asset_zones_obj.map(function (ele) {
                    vm.spare.spare_asset_zones.push(ele.asset_service_id);
                });
