    ...
    export default {
        ...
        methods: {
            ...
            editService(service) {
                ...
                // });
                const matchingZone = this.asset_zones.find(zone => zone.template_zone_id === service.template_zone_id);
                this.service.service_template_zones_obj = matchingZone ? [matchingZone] : [{
                    asset_template_id: service.asset_zone.asset_template_id,
                    template_zone_id: service.asset_zone.template_zone_id,
                    zone_name: service.asset_zone.zone_name,
                    diameter: service.asset_zone.diameter,
