                ...
                <ol class="breadcrumb fs-sm mb-1">
                    <li class="breadcrumb-item" aria-current="page">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> <a href="javascript:void(0)">Users</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Inactive Users</li>
                </ol>
                <h4 class="main-title mb-0">Inactive Users</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-one">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <router-link to="/users" class="btn btn-success" style="float: right; padding: 2px 8px; font-size: 12px; line-height: 1.2;">Active Users</router-link>
                    </div>
                    <div class="card-body">
