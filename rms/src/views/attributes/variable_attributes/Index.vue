                                        ...
                                        <tr v-for="variableattribute, key in variableattributes" :key="key">
                                            ...
                                            <td class="text-center" v-can="'variable_attributes.delete'">
                                                <div class="form-switch" >
                                                    <input class="form-check-input"  type="checkbox" role="switch" :id="'variableattribute' + variableattribute.variable_attribute_id" :checked="variableattribute.status" :value="variableattribute.status" @change="deleteVariableAttribute(variableattribute)" :disabled="['var_lcl', 'var_ucl'].includes(variableattribute.field_name.toLowerCase())"/>
        ...
        methods: {
            index() {
                ...
                this.$store.dispatch('post', { uri: 'paginateVariableAttributes', data: vm.meta })
                    .then(response => {
                        loader.hide();
                        vm.variableattributes = response.data.data;
