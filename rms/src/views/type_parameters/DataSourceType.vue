                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Data Source Type Code" class="form-control" :class="{ 'is-invalid': errors.data_source_type_code }" v-model="data_source_type.data_source_type_code" ref="data_source_type_code" :disabled="!status"/>
