                ...
                <form @submit.prevent="submitForm()">
                    <div class="card card-one">
                                ...
                                <div class="card-body">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" placeholder="Enter Asset Code" class="form-control" :class="{ 'is-invalid': errors?.asset_code }" v-model="asset.asset_code" :disabled="!status"/>
                        ...
                        <div class="card-footer text-end">
                            ...
                            <router-link type="button" class="btn btn-danger me-2" to="/assets"><i class="ri-close-line fs-18 lh-1"></i> Discard</router-link>
            ...
            "asset.no_of_zones": function (newVal) {
                ...
                if (newVal === 0) {
                    ...
                    if (vm.asset.zone_name.length > 1) {
                        ...
                        if (removedZone.asset_zone_id != null) {
                            vm.asset.deleted_asset_zones.push(removedZone.asset_zone_id);
                        }
                    }
                    ...
                    vm.asset.zone_name = [
                        {
                            ...
                            asset_zone_id: existingOverallZone?.asset_zone_id ?? null,
                        },
                    ];
                    return;
                }
                ...
                if (vm.asset.zone_name.length > requiredZones) {
                    for (let i = requiredZones; i < vm.asset.zone_name.length; i++) {
                        ...
                        if (assetzone.asset_zone_id != null) {
                            vm.asset.deleted_asset_zones.push(assetzone.asset_zone_id);
                        }
                    }
