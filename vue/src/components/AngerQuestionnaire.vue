    ...
    <div class="container py-4">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-accent">
                <h5 class="mb-0 text-center">Anger Management</h5>
            </div>
                    ...
                    <div v-for="(question, qIndex) in questions" :key="qIndex" class="mb-4">
                        ...
                        <div class="d-flex flex-column ms-3 gap-2">
                            ...
                            <button
                                ...
                                :key="oIndex"
                                type="button"
                                class="btn rounded-pill text-start"
                                :class="{
                                    'btn-outline-theme w-100': question.answer !== option,
                                    'btn-theme w-100 fw-bold': question.answer === option
                                }"
