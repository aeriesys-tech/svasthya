		...
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container-fluid d-flex align-items-center justify-content-between">
				...
				<div class="d-flex align-items-center ms-auto">
					...
					<!-- Theming Settings -->
					<button class="btn btn-link btn-square btn-icon btn-link-header position-relative" type="button"
						data-bs-toggle="offcanvas" data-bs-target="#theming">
					...
					<div class="dropdown" ref="dropdownRef">
						<button class="btn btn-link btn-square btn-icon btn-link-header dropdown-toggle no-caret"
							type="button" @click="toggleDropdown" :aria-expanded="isDropdownOpen">
							<i class="bi bi-translate"></i>
						</button>
						<ul class="dropdown-menu dropdown-menu-end" :class="{ show: isDropdownOpen }">
							<li>
								<a class="dropdown-item" :class="{ active: currentLocale === 'en' }"
									@click="changeLanguage('en')" href="javascript:void(0)">
									EN - English
								</a>
							</li>
							<li>
								<a class="dropdown-item" :class="{ active: currentLocale === 'kn' }"
									@click="changeLanguage('kn')" href="javascript:void(0)">
									KAN - Kannada
								</a>
							</li>
						</ul>
					...
					<button class="btn btn-link btn-square btn-icon btn-link-header position-relative"
						data-bs-toggle="offcanvas" data-bs-target="#view-notification">
