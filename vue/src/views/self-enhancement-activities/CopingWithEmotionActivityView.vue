<template>
    <div class="container py-5">
        <h1 class="mb-4 text-center fw-bold">Coping With Emotions</h1>

        <div class="accordion" id="emotionAccordion">
            <div
...
/* ----------------------------------------
   COPING WITH EMOTIONS ACTIVITIES
-----------------------------------------*/
const activities = ref([
    ...
    },
    {
        ...
        description: "Write your current worry. Then evaluate how much of it is actually in your control.",
        fields: [
    ...
    },
    {
        ...
        description: "Check your stress level right now and focus on reducing it by at least 1 point.",
        fields: [
            { label: "Rate your stress right now (1–10):", value: "" },
    ...
    {
        title: "Think Shift",
        description: "Take the stressful thought and find a healthier alternate way to see it.",
        fields: [
    ...
    },
    {
        ...
        description: "Write two activities that recharge you and do one today.",
        fields: [
            { label: "1️⃣", value: "" },
            { label: "2️⃣", value: "" },
        ],
    ...
    },
    {
        ...
        description: "Before bed, reflect on your day to create emotional closure.",
        fields: [
