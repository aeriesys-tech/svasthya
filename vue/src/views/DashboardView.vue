<template>
    <div class="container py-4">
        ...
        <!-- Greeting -->
        <h4 class="mb-4 ps-2">Hi Sachin,&nbsp;{{ greeting }}</h4>
        ...
        <div class="card p-3 mb-4">
            ...
            <div class="row mt-3">
                <div
                    class="col-4 col-md-2 col-lg-2 text-center mb-3"
        ...
        <div class="mb-4">
            <button
                class="btn reflectionbutton w-100 fw-bold rounded"
                ...
                <div class="modal-content rounded-4 border-danger">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-if="currentStep === 1" class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="reflectionAnswers.q1" placeholder="Write one line..." />
                        </div>
                        ...
                        <div v-if="currentStep === 2" class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="reflectionAnswers.q2" placeholder="Your first thought..." />
                        </div>
                        ...
                        <div v-if="currentStep === 3" class="mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-2">
                                <button
                                    v-for="(option, index) in reflectionMoods"
                                    :key="index"
                                    type="button"
                                    class="btn"
                                    :class="reflectionAnswers.q3 === option.label 
                                        ? 'btn-danger text-white' 
                                        : 'btn-outline-secondary text-dark'"
                                    @click="reflectionAnswers.q3 = option.label"
                                >
                        ...
                        <div v-if="currentStep === 4" class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="reflectionAnswers.q4" placeholder="Your action or reaction..." />
                        </div>
                        ...
                        <div v-if="currentStep === 5" class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="reflectionAnswers.q5" placeholder="A fairer or lighter view..." />
                        </div>
                        ...
                        <div v-if="currentStep === 6" class="mb-3">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                <div v-for="i in 5" :key="i">
                                    <input type="radio" class="btn-check" :name="'reflectionRate'" :id="'rate'+i" :value="i" v-model="reflectionAnswers.q6" />
        ...
        <div class="video-container">
            <iframe
                ...
                src="https://www.youtube.com/embed/N_28cfeGeQM?si=OwnoXY8Y_bGTZI_-"
                frameborder="0"
                allowfullscreen
            ></iframe>
        </div>
        ...
        <div class="mb-4 ps-2 mt-3">
            <div class="row g-3 mt-2">
                <div class="col-6 text-center">
                    ...
                    <div class="video-container mt-3 rounded">
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/5Be62_oZjyo?si=JPlMPxxkTBYnKtxV"
                            frameborder="0"
                            allowfullscreen
                        ></iframe>
                    </div>
                ...
                <div class="col-6 text-center">
                    ...
                    <div class="video-container mt-3 rounded">
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/IyqLDC4US6Y?si=JxfAOoLMtt8YPezP"
                            frameborder="0"
                            allowfullscreen
                        ></iframe>
                    </div>
